...
::: notes
the title of this talk is about tool users and tool builders.
...
grow with users: (rodrigo's talk tomorrow morning and jules talk tomorrow morning)

JULES TALK 9am tomorrow
...
it is _integral_ for trustworthy science, but there is a strong pull for exploring data in 
...
Discoverability is the eternal quest. Hidden features are like secret passages—even if they lead to treasure, they're useless if no one finds them. with something like "Render on save" ; bringing it to the surface makes it actually usable.

we're looking to make ui changes to how our jupyter notebooks look to ease discoverability, and if you're interested in chatting, come say hi at the posit booth!
:::
...
-> what tools are you using? are they compatible with each other? 

-> think critically about your use case, is there a way to bridge them together or extend them specifically to better fit your use case? (JULES talk about extension packages)
